            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-2">
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Lapangan</h3>
                            <div class="d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-4">
                        <div class="card-body">
                            <h3 class="card-title text-white">Kepuasan Customer</h3>
                            <div class="d-inline-block">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin-assets/images/users/8.jpg') }}" class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin-assets/images/users/5.jpg') }}" class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin-assets/images/users/7.jpg') }}" class="rounded-circle"
                                    alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="{{ asset('admin-assets/images/users/1.jpg') }}" class="rounded-circle"
                                    alt="">
                            ...
                            <div class="active-member">
                                <div class="table-responsive">
                                    <table class="table table-xs mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/1.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/2.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/3.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/6.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/4.jpg') }}"
                                            ...
                                            <tr>
                                                <td><img src="{{ asset('admin-assets/images/avatar/5.jpg') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin-assets/images/avatar/1.jpg') }}"
                                ...
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin-assets/images/avatar/2.jpg') }}"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin-assets/images/avatar/3.jpg') }}"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card gradient-1">
                        <div class="card-body">
                            <h3 class="card-title text-white">Selamat Datang, {{ Auth::user()->name }}!</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">Jelajahi fitur yang kami sediakan</h2>
                                <p class="text-white mb-0">Untuk mendapatkan bantuan terkait website, hubungi
                                    Administrator: 081234567890 </p>
                            </div>
